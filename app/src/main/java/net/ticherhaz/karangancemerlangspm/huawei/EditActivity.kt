...
import net.ticherhaz.karangancemerlangspm.huawei.model.BookEditFields
...
class EditActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        ...
        when (action) {
            ACTION_ADD -> {
                val editMode = BookEditFields.EditMode.valueOf(
                ...
                if (editMode == EditMode.MODIFY) {
                    ...
                    priceEdit.setText(String.format(
                ...
                publishTimeEdit.setOnClickListener {
                    DatePickerDialog(
                        this@EditActivity,
                        R.style.Theme_Material_Dialog_NoActionBar_MinWidth,
